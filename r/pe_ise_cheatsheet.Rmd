...
chiTable <- data.frame(v = paste0("**", v, "**"),
                       chiTable,
                       stringsAsFactors = FALSE,
                       check.names = FALSE)
...
fTable95 <- data.frame(v2 = paste0("**", v2, "**"),
                       fTable95,
                       stringsAsFactors = FALSE,
                       check.names = FALSE)
...
v1 <- c(seq(1, 10, by = 1), 12, 15, 20, 24, 30, 40, 60, 120, Inf)
v2 <- v1
fTable99 <- sapply(v1, function(x) round(qf(.99, x, v2), 2))
colnames(fTable99) <- v1
rownames(fTable99) <- v2
fTable99 <- data.frame(v2 = paste0("**", v2, "**"),
                       fTable99,
                       stringsAsFactors = FALSE,
                       check.names = FALSE)
